...
private:
  template <typename T>
  std::string ToStringInt(const T *x, int n, int w, unsigned int select) {
  ...
  template <typename T>
  std::string ToStringUint(const T *x, int n, int w, unsigned int select) {
    std::ostringstream oss;
  ...
  template <typename T>
  std::string ToStringHex(const T *x, int n, int w, unsigned int select) {
    std::ostringstream oss;
  ...
  template <typename T>
  std::string ToStringFP(const T *x, int n, int w, int p, unsigned int select) {
    std::ostringstream oss;
